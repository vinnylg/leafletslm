...
install:
	...
	@echo ""
# 	@echo "  make generate-bash >> ~/.bashrc"
# 	@echo "  make generate-zsh  >> ~/.zshrc"
# 	@echo "  make generate-fish >> ~/.config/fish/config.fish"
	@echo ""
...
# ## Enters a new bash with the environment activated
# .PHONY: bash
# bash:
# 	@echo ">>> Spawning a new shell within the virtual environment..."
# 	@echo ">>> Type 'exit' to return to your normal terminal."
# 	uv run bash

# ## Enters a new zsh with the environment activated
# .PHONY: zsh
# zsh:
# 	@echo ">>> Spawning a new shell within the virtual environment..."
# 	@echo ">>> Type 'exit' to return to your normal terminal."
...
# ## Enters a new fish with the environment activated
# .PHONY: fish
# fish:
# 	@echo ">>> Spawning a new shell within the virtual environment..."
# 	@echo ">>> Type 'exit' to return to your normal terminal."
...
## DO SOMETHING LIKE docs and dagster for generete-* and shells (make activate fish {uv run dhell is perfect to it})
...
# 	@echo ""
# 	@echo "# =================================================================="
# 	@echo "# UV Toolchain Configuration (Generated by $(PROJECT):$(VERSION))"
# 	@echo "# =================================================================="
# 	@echo ""
# 	@echo 'export PATH="$$HOME/.local/bin:$$PATH"'
# 	@echo 'eval "$$(uv generate-shell-completion bash)"'
...
# 	@echo 'uv generate-shell-completion fish | source'
# 	@echo 'uvx --generate-shell-completion fish | source'
# 	@echo ""
# 	@echo "# =================================================================="
# 	@echo ""
...
info:
	...
	@echo "----------------------------------------------------------------------"
	@echo ""
	@echo "  1. Nested Shell (Easiest for make users):"
	@echo "     Run 'make bash', 'make zsh', or 'make fish' to spawn a configured"
	@echo "     shell inside the environment. Type 'exit' to leave."
	@echo ""
	@echo "  2. Manual Activation (Current Shell):"
	@echo "     Run 'source $(VENV_PATH)/bin/activate' to activate in your current terminal."
	@echo "     (Does not spawn a nested shell)."
	@echo ""
	@echo "  3. Auto-Activation (Recommended for Docker/Persistent):"
	@echo "     Add the activation command to your shell config file:"
	@echo "     [Bash] echo 'source $$(pwd)/$(VENV_PATH)/bin/activate' >> ~/.bashrc"
	@echo "     [Zsh]  echo 'source $$(pwd)/$(VENV_PATH)/bin/activate' >> ~/.zshrc"
	@echo "     [Fish] echo 'source $$(pwd)/$(VENV_PATH)/bin/activate.fish' >> ~/.config/fish/config.fish"
	@echo ""
	...
	@echo "      - uv run module"
	@echo "     This is simple and often used in this Makefile"
	@echo ""
	@echo "======================================================================"
	@echo ""
...
docs:
	@if [ -z "$(DOCS_ARGS)" ]; then \
		...
		mkdocs serve -f ./mkdocs.yaml -a 0.0.0.0:8000; \
		...
		mkdocs gh-deploy -f ./mkdocs.yaml; \
	else \
