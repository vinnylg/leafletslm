...
Select a topic below to explore the system's internal design:
...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 1rem; margin: 2rem 0;">
  ...
  <div style="border: 1px solid #ddd; border-radius: 8px; padding: 1.5rem;">
    <h3>🎨 Visual Standards</h3>
    <p>The definitive guide to the project's visual language. Defines the taxonomy for data artifacts, flow shapes, and execution status colors used in all diagrams.</p>
    <a href="standards/"><strong>Explore Standards →</strong></a>
  </div>
